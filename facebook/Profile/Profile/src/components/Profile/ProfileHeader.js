    ...
    return (
        <div>
            <div className=" w-full flex justify-center w-80" style={{ height: '348px' }}>
                <div className="flex flex-col">
                    ...
                    <div className="md:relative bg-gray-100 md:rounded-bl-lg md:rounded-br-lg
                        ...
                        {/* // cover photo */}
                        <img  src="./images/sander-yigin-mq20oFDrdBA-unsplash.jpg"   style={{ width: '100%', height: '100%' }}  className="rounded-xl" />
                        
                        <div className="">
                            {/* profile photo */}
                            <img src="./images/per13.png"
            ...
            <div className="flex justify-center flex-col mt-5 mb-3.5">
                <h1 className="text-center font-bold text-3xl">Osman elrawy</h1>
